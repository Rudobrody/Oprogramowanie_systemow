...
int pozycja = 1;
int liczba;
int dziesiatki_x, jednosci_x, dziesiatki_y, jednosci_y;
int liczba_x, liczba_y;
...
int ktora_cyfre_wprowadza =0;
  ...
  fprintf(outputCSV,CSV_NAGLOWEK);
        ...
        while (1)
        {
            ...
            przeksztalc_na_wspolrzedne(dziesiatki_x, jednosci_x, dziesiatki_y, jednosci_y);
...
*/
    ...
    void wybierz_pozycje(int ktora_pozycja)
    {
       ...
       {
       case 1:
           Key_nie_ASCII=(unsigned char)liczba % 10 +'0';
           Bufor_wsp_X[9] = Key_nie_ASCII;
           byl_wcisniety = 0;
           dziesiatki_x=liczba;
    ...
    {
        liczba_x=((dziesiatki_x*10)+(jednosci_x));
        liczba_y=((dziesiatki_y*10)+(jednosci_y));
    }
